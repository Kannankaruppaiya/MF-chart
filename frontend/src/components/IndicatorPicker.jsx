...
const TYPES = [
  { type: "SMA", name: "SMA — Simple Moving Average", desc: "Arithmetic mean of last N NAV values. Overlay on chart." },
  { type: "EMA", name: "EMA — Exponential Moving Average", desc: "Weighted average favoring recent values. Overlay on chart." },
